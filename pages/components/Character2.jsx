...
export default function Character2({ cost, name }) {
  return (
    <div className="bg-slate-900 w-56 h-56 rounded-4xl p-2 shadow-2xl flex flex-col relative hover:scale-105 transition-transform duration-300 ease-in-out cursor-pointer">
      <div
        className={`w-[20px] h-[20px] bg-green-400 absolute rounded-full transition-all ease-out duration-150 top-[100px] right-[100px]`}
      >
